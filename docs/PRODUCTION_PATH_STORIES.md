...
- **Status (2026-07-27):** **Done (docs)** — no live AWS deploy in this pass.
  - PP-040: `docs/deploy/EMAIL_DELIVERABILITY.md`
  - PP-041: `docs/deploy/WHATSAPP_META_SETUP.md`
  - PP-042: `docs/deploy/PRODUCTION_PATH_RUNBOOK.md`
  - PP-043: `docs/PROJECT_STATUS.md` + `.env.example` + `docs/notifications/IMPLEMENTATION_NOTES.md` addendum
