...
| DEF-BE-007 | Minor | Ops | Packaged jar cannot switch to H2 via runtime profile alone | **OPEN** | Not re-run; prior evidence stands; smoke uses `quarkus:dev` | STORY-017 |
